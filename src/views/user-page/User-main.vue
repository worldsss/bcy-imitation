        ...
        <el-row :gutter="10" style="width: 70%;margin:0 auto">
         <el-col :span="16">
             <div style="position: relative;top: 0;background-color: #ffffff; box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1)">
                 ...
                 <el-avatar :src="src03" :size="120" style="position:absolute;top: 100px;left: 30px;border: 5px solid"></el-avatar>
             ...
             <el-card>
                 <el-row :gutter="10">
                     ...
                     <el-col :span="8" class="my-like-img-height" >
                         <el-link> <el-image :src="likeImg[1]" ></el-image></el-link>

                     </el-col>
                     <el-col :span="8" class="my-like-img-height">
                         <el-link> <el-image :src="likeImg[2]"></el-image></el-link>
